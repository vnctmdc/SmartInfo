...
import {
    Text, TextInput, View, Modal, TouchableOpacity, FlatList
} from 'react-native'
            ...
            <View style={{ flexDirection: "row" }}>
                <View style={Theme.DropdownListInput}>
                    <TouchableOpacity activeOpacity={0.5}
                        onPress={() => { this.showPopupItem() }}
                        style={{ backgroundColor: '#F5F5F5', flex: 1, flexDirection: "row" }}>
                        <TextInput style={{ fontSize: 16, flex: 1, textAlign: "left" }} value={this.getSelectedText()}
                            editable={false} pointerEvents="none" placeholder={this.props.PlaceHolder} />
                ...
                <Modal visible={this.state.showItemList} transparent={true} animationType="fade" >
                    <View style={{
                        padding: 30, backgroundColor: '#00000040', flex: 1,
                    }}>
                        <View style={{ flex: 1, backgroundColor: '#ffffff', borderRadius: 10, justifyContent: "space-between" }}>
                            ...
                            <TouchableOpacity
                                style={{ alignItems: "center", borderTopColor: "#acacac", borderTopWidth: 1, padding: 7 }}
                                onPress={() => { this.setState({ showItemList: false }) }}>
